...
export class UploadController {
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        url: 'https://bucket.s3.region.amazonaws.com/profiles/userId/uuid.jpg',
  ...
  async uploadProfileImage(
    ...
    return this.uploadService.uploadProfileImage(req.user.userId, {
      buffer: file.buffer,
  ...
  @ApiResponse({
    ...
    schema: {
      example: {
        url: 'https://bucket.s3.region.amazonaws.com/logos/userId/resumeId/uuid.png',
  ...
  async uploadCompanyLogo(
    ...
    return this.uploadService.uploadCompanyLogo(req.user.userId, resumeId, {
      buffer: file.buffer,
      originalname: file.originalname,
      mimetype: file.mimetype,
      size: file.size,
